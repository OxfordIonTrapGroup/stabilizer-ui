# From m-labs/artiq@55aeb9eb0ed6ad2d4bbf343439bc0888e0d0f666 (LGPL v3); copied in to
# avoid depending on ARTIQ proper which has a number of unfriendly dependencies
# (llvmlite, etc).
...
_float_acceptable = re.compile(r"([-+]?\d*(?:\d|\.\d|\d\.)\d*)(?:[eE]([-+]?\d+))?", )
